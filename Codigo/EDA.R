...
celebrity_deaths_4 <- read.csv("~/Desktop/Script_Uniempresarial/Bases_de_datos/celebrity_deaths_4.csv",na.strings = c("", "NA"), stringsAsFactors = F)
